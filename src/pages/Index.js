  ...
  const loaded = () =>
    blogs.map((blog) => (
      <>
        ...
        <div
          key={blog._id}
          className="max-w-xl mx-auto mt-10 bg-white rounded-xl shadow-md overflow-hidden"
        >
          <div className="p-6">
            ...
            <p className="text-gray-800 mb-2">{reading(blog.body, 200)}</p>
            <span className="text-gray-600">
              {timeToRead(blog.body)} min read
            </span>
